...
def create_student():
    ...
    new_student = {
        ...
        'grade': request.json.get('grade', 'N/A'),  # The grade is optional; default is 'N/A' if not provided
        'email': request.json.get('email', '')  # The email is optional; default is an empty string if not provided
    }
